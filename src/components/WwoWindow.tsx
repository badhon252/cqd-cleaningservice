        ...
        <div className="container max-w-9xl mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
              ...
              <div className="space-y-4">
                <p className="text-base md:text-lg text-gray-700">
                  At CQD Cleaning Services, we combine reliability,
                  professionalism, and value to deliver spotless results every
                  time. Our trained team is committed to providing flexible,
                  efficient, and high-quality cleaning tailored to your schedule
                  and budget.
                </p>

                <p className="text-base md:text-lg text-gray-700">
                  At CQD Cleaning Service, we deliver trusted, thorough cleaning
                  solutions tailored to your needs. Our expert team ensures
                  spotless results with care, reliability, and efficiency every
                  time.
                </p>
              </div>
